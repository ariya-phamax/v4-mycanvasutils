...
!function(t, e) {
    ...
    var l = new function() {
        ...
        this.on = function(e, n, r, o, i) {
            ...
            "addEventListener"in e ? e.addEventListener(n, s, i) : "attachEvent"in e && e.attachEvent("on".concat(n), s),
            e[t] = e[t] || {},
            e[t][a] = s
        }
        ,
        this.off = function(e, n, r, o, i) {
            var a = this._id.apply(this, arguments)
              , s = e[t] && e[t][a];
            s && ("removeEventListener"in e ? e.removeEventListener(n, s, i) : "detachEvent"in e && e.detachEvent("on".concat(n), s),
            e[t][a] = null)
        }
    }
    ;
    ...
    function b(t, e, n) {
        var r, o = e.element;
        if ("off" !== t && (this._options.scrollToElement && (r = "tooltip" === t ? n.getBoundingClientRect() : o.getBoundingClientRect(),
        !function(t) {
    ...
    )), H = {}.propertyIsEnumerable, F = Object.getOwnPropertyDescriptor, D = {
        f: F && !H.call({
            1: 2
        }, 1) ? function(t) {
            var e = F(this, t);
    ...
    }, G = L({}.toString), z = L("".slice), W = function(t) {
        return z(G(t), 8, -1)
    ...
    }, nt = L({}.isPrototypeOf), rt = et("navigator", "userAgent") || "", ot = B.process, it = B.Deno, at = ot && ot.versions || it && it.version, st = at && at.v8;
    st && (R = (P = st.split("."))[0] > 0 && P[0] < 4 ? 1 : +(P[0] + P[1])),
    !R && rt && (!(P = rt.match(/Edge\/(\d+)/)) || P[1] >= 74) && (P = rt.match(/Chrome\/(\d+)/)) && (R = +P[1]);
    var ct = R
    ...
    : function(t) {
      ...
      , ne = {
        f: M ? Vt ? function(t, e, n) {
            ...
            e = Ht(e),
            Kt(n),
            "function" == typeof t && "prototype" === e && "value"in n && ee in n && !n.writable) {
                var r = Jt(t, e);
    ...
    var le, ue, he, pe = xt.inspectSource, fe = B.WeakMap, de = J(fe) && /native code/.test(pe(fe)), be = _t("keys"), me = function(t) {
        return be[t] || (be[t] = It(t))
    }, ge = {}, ve = "Object already initialized", ye = B.TypeError, we = B.WeakMap;
    if (de || xt.state) {
    ...
    var Ce = {
      ...
      , Ae = O((function(t) {
        var e = se.CONFIGURABLE
          ...
          , s = t.exports = function(t, r, s) {
            ...
            s && s.getter && (r = "get " + r),
            s && s.setter && (r = "set " + r),
            (!Ct(t, "name") || e && t.name !== r) && (M ? o(t, "name", {
                value: r,
                configurable: !0
            }) : t.name = r),
            i && s && Ct(s, "arity") && t.length !== s.arity && o(t, "length", {
                value: s.arity
            });
            try {
            ...
            var c = n(t);
            return Ct(c, "source") || (c.source = a.join("string" == typeof r ? r : "")),
            t
        }
        ;
      ...
      , Be = function(t) {
        return function(e, n, r) {
            var o, i = Q(e), a = qe(i.length), s = function(t, e) {
                var n = Te(t);
      ...
      , De = function(t, e) {
        var n, r = Q(t), o = 0, i = [];
        for (n in r)
            !Ct(ge, n) && Ct(r, n) && Fe(i, n);
        for (; e.length > o; )
            Ct(r, n = e[o++]) && (~He(i, n) || Fe(i, n));
        return i
    }
      ...
      , nn = Wt.f
      , rn = function(t, e) {
        var n, r, o, i, a, s = t.target, c = t.global, l = t.stat;
        if (n = c ? B : l ? B[s] || yt(s, {}) : (B[s] || {}).prototype)
            for (r in e) {
                ...
                (t.sham || o && o.sham) && re(i, "sham", !0),
                Ee(n, r, i, t)
            }
    }
      , on = {};
    on[Rt("toStringTag")] = "z";
    var an, sn = "[object z]" === String(on), cn = Rt("toStringTag"), ln = Object, un = "Arguments" == W(function() {
        return arguments
    }()), hn = sn ? W : function(t) {
        var e, n, r;
    ...
    , xn = {
        f: wn
    }, _n = et("document", "documentElement"), kn = me("IE_PROTO"), Sn = function() {}, jn = function(t) {
        ...
        var t, e;
        An = "undefined" != typeof document ? document.domain && an ? Cn(an) : ((e = $t("iframe")).style.display = "none",
        _n.appendChild(e),
        ...
        for (var n = $e.length; n--; )
            delete An.prototype[$e[n]];
        return An()
    };
    ge[kn] = !0;
    var En, Nn, In = Object.create || function(t, e) {
        var n;
        return null !== t ? (Sn.prototype = Kt(t),
        n = new Sn,
        Sn.prototype = null,
        n[kn] = t) : n = An(),
        void 0 === e ? n : xn.f(n, e)
    }
    , Ln = B.RegExp, Tn = y((function() {
        var t = Ln(".", "s");
        return !(t.dotAll && t.exec("\n") && "s" === t.flags)
    }
    )), On = B.RegExp, Pn = y((function() {
        var t = On("(?<a>b)", "g");
        return "b" !== t.exec("b").groups.a || "bc" !== "b".replace(t, "$<a>c")
    }
    )), Rn = Ce.get, qn = _t("native-string-replace", String.prototype.replace), Bn = RegExp.prototype.exec, Mn = Bn, Hn = L("".charAt), Fn = L("".indexOf), Dn = L("".replace), $n = L("".slice), Gn = (Nn = /b*/g,
    C(Bn, En = /a/, "a"),
    C(Bn, Nn, "a"),
    0 !== En.lastIndex || 0 !== Nn.lastIndex), zn = vn.BROKEN_CARET, Wn = void 0 !== /()??/.exec("")[1];
    (Gn || Wn || zn || Tn || Pn) && (Mn = function(t) {
        var e, n, r, o, i, a, s, c = this, l = Rn(c), u = fn(t), h = l.raw;
        if (h)
        ...
        Gn && (r = c.lastIndex),
        o = C(Bn, f ? n : c, g),
        f ? o ? (o.input = $n(o.input, m),
        o[0] = $n(o[0], m),
        o.index = c.lastIndex,
        c.lastIndex += o[0].length) : c.lastIndex = 0 : Gn && o && (c.lastIndex = c.global ? o.index + o[0].length : r),
        Wn && o && o.length > 1 && C(qn, o[0], n, (function() {
            for (i = 1; i < arguments.length - 2; i++)
                void 0 === arguments[i] && (o[i] = void 0)
        }
        )),
        o && p)
            for (o.groups = a = In(null),
            i = 0; i < p.length; i++)
                a[(s = p[i])[0]] = o[s[1]];
        return o
    }
    ...
    var Un = Rt("species")
      ...
      , Jn = function(t) {
        return function(e, n) {
            var r, o, i = fn(X(e)), a = Te(n), s = i.length;
    ...
    !function(t, e, n, r) {
        ...
        , function(t, o) {
            ...
            for (var f, d = "", b = 0, m = 0; m < h.length; m++) {
                for (var g = fn((p = h[m])[0]), v = hr(pr(Te(p.index), a.length), 0), y = [], w = 1; w < p.length; w++)
    ...
    function Lr(t, e, n, r) {
        ...
        this._introItems[this._currentStep]) {
            l = "string" == typeof (o = this._introItems[this._currentStep]).tooltipClass ? o.tooltipClass : this._options.tooltipClass,
            e.className = ["introjs-tooltip", l].filter(Boolean).join(" "),
            e.setAttribute("role", "dialog"),
            "floating" !== (c = this._introItems[this._currentStep].position) && this._options.autoPosition && (c = Ir.call(this, t, e, c)),
            a = v(t),
            i = v(e),
            s = d(),
            ...
            case "right":
                ...
                a.top + i.height > s.height ? (n.className = "introjs-arrow left-bottom",
                e.style.top = "-".concat(i.height - a.height - 20, "px")) : n.className = "introjs-arrow left";
                break;
            case "left":
                r || !0 !== this._options.showStepNumbers || (e.style.top = "15px"),
                a.top + i.height > s.height ? (e.style.top = "-".concat(i.height - a.height - 20, "px"),
    ...
    function Dr(t) {
        t.querySelector(".introjs-progress .introjs-progressbar").style.cssText = "width:".concat(Rr.call(this), "%;"),
        t.querySelector(".introjs-progress .introjs-progressbar").setAttribute("aria-valuenow", Rr.call(this))
    }
    function $r(t) {
            ...
            return t().wrap((function(e) {
                for (; ; )
                    ...
                    case 3:
                        ...
                        null !== i && null !== a ? (d = a.querySelector(".introjs-helperNumberLayer"),
                        ...
                        o._lastShowElementTimer = window.setTimeout((function() {
                            null !== d && (d.innerHTML = "".concat(n.step, " ").concat(P._options.stepNumbersOfLabel, " ").concat(P._introItems.length)),
                            g.innerHTML = n.intro,
                            v.innerHTML = n.title,
                            ...
                            Dr.call(o, a),
                            w.style.opacity = 1,
                            (null != c && /introjs-donebutton/gi.test(c.className) || null != c) && c.focus(),
                        ...
                        S.appendChild(C),
                        S.appendChild(j),
                        this._options.dontShowAgain && (N = Or("div", {
                        ...
                        T = Or("div"),
                        !0 === this._options.showStepNumbers && (T.className = "introjs-helperNumberLayer",
                        T.innerHTML = "".concat(n.step, " ").concat(this._options.stepNumbersOfLabel, " ").concat(this._introItems.length),
                        S.appendChild(T)),
                        S.appendChild(k),
                        _.appendChild(S),
                        (c = Or("a")).onclick = r(t().mark((function e() {
                        ...
                        (l = Or("a")).onclick = r(t().mark((function e() {
                            return t().wrap((function(t) {
                                for (; ; )
                                    switch (t.prev = t.next) {
                                    case 0:
                        ...
                        (O = o._targetElement.querySelector(".introjs-disableInteraction")) && O.parentNode.removeChild(O),
                        n.disableInteraction && qr.call(o),
                        0 === this._currentStep && this._introItems.length > 1 ? (null != c && (c.className = "".concat(this._options.buttonClass, " introjs-nextbutton"),
                        c.innerHTML = this._options.nextLabel),
                        !0 === this._options.hidePrev ? (null != l && (l.className = "".concat(this._options.buttonClass, " introjs-prevbutton introjs-hidden")),
                        null != c && u(c, "introjs-fullbutton")) : null != l && (l.className = "".concat(this._options.buttonClass, " introjs-prevbutton introjs-disabled"))) : this._introItems.length - 1 === this._currentStep || 1 === this._introItems.length ? (null != l && (l.className = "".concat(this._options.buttonClass, " introjs-prevbutton")),
                        !0 === this._options.hideNext ? (null != c && (c.className = "".concat(this._options.buttonClass, " introjs-nextbutton introjs-hidden")),
                        null != l && u(l, "introjs-fullbutton")) : null != c && (!0 === this._options.nextToDone ? (c.innerHTML = this._options.doneLabel,
                        u(c, "".concat(this._options.buttonClass, " introjs-nextbutton introjs-donebutton"))) : c.className = "".concat(this._options.buttonClass, " introjs-nextbutton introjs-disabled"))) : (null != l && (l.className = "".concat(this._options.buttonClass, " introjs-prevbutton")),
                        null != c && (c.className = "".concat(this._options.buttonClass, " introjs-nextbutton"),
                        c.innerHTML = this._options.nextLabel)),
            ...
            return t().wrap((function(t) {
                for (; ; )
                    ...
                    case 0:
                        ...
                        void 0 !== this._currentStepNumber && c(this._introItems, (function(t, e) {
                            t.step === o._currentStepNumber && (o._currentStep = e - 1,
        ...
        return (io = r(t().mark((function e(n) {
            ...
            return t().wrap((function(t) {
                for (; ; )
                    switch (t.prev = t.next) {
                    case 0:
                        if (r = ro('.introjs-hint[data-step="'.concat(n, '"]'))[0],
                        vo.call(this),
            ...
            var n = r(t().mark((function n(r) {
                return t().wrap((function(t) {
                    for (; ; )
                        ...
                        case 0:
                            return t.next = 2,
                            oo.call(e, r.getAttribute("data-step"));
                        case 2:
                        case "end":
                            return t.stop()
                        }
        ...
        return (co = r(t().mark((function e() {
            ...
            return t().wrap((function(t) {
                for (; ; )
                    ...
                    case 5:
                        return t.next = 7,
                        yo.call(this, this._targetElement);
                    case 7:
                    case "end":
                        return t.stop()
                    }
    ...
    function uo() {
        ...
        this._hintsAutoRefreshFunction && l.off(window, "scroll", this._hintsAutoRefreshFunction, this, !0)
    }
    function ho(t) {
        var e = ro('.introjs-hint[data-step="'.concat(t, '"]'))[0];
        ...
        return (fo = r(t().mark((function e() {
            ...
            return t().wrap((function(t) {
                for (; ; )
                    ...
                    case 0:
                        if (n = this,
                        null === (r = document.querySelector(".introjs-hints")) && (r = Or("div", {
            ...
            return t().wrap((function(t) {
                for (; ; )
                    ...
                    case 0:
                        ...
                        return t.next = 5,
                        this._hintClickCallback.call(this, r, o, n);
                    case 5:
                        if (i = vo.call(this),
                        parseInt(i, 10) !== n) {
                            t.next = 8;
                    ...
                    case 8:
                        ...
                        s.appendChild(u),
                        this._options.hintShowButton && ((h = Or("a")).className = this._options.buttonClass,
    ...
    function ko(t) {
        ...
        xr.call(this, e),
        xr.call(this, r),
        t && (this._introItems = _o.call(this, this._targetElement),
    ...
    function Eo(e) {
        ...
        e.appendChild(o),
        !0 === this._options.exitOnOverlayClick && (wr(o, {
            cursor: "pointer"
        }),
    ...
    var Bo = function t(n) {
        ...
        if ("object" === e(n))
            ...
            r = new qo(document.body);
        return t.instances[s(r, "introjs-instance")] = r,
        r
    };
    return Bo.version = "6.0.0",
    Bo.instances = {},
    Bo.fn = qo.prototype = {
        isActive: function() {
